...
import { GithubIcon, TwitterIcon, HexagonIcon, Linkedin, Crown } from "lucide-react";
...
export function Navbar() {
  return (
    <nav className="w-full border-b border-gradient-to-r from-purple-500 via-pink-500 to-red-500 h-16 sticky top-0 z-50 lg:px-4 px-2 backdrop-filter backdrop-blur-xl bg-opacity-5">
